...
public class ChurchListAdaptor extends RecyclerView.Adapter<ChurchListAdaptor.MyViewHolder> {
    private ArrayList<ChurchModelClass> churchModelClasses;
    Context context;
    Drawable drawable;

    public ChurchListAdaptor(ArrayList<ChurchModelClass> churchModelClasses, Context context) {
