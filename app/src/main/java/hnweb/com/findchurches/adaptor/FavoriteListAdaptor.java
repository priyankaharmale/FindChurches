...
public class FavoriteListAdaptor extends RecyclerView.Adapter<FavoriteListAdaptor.MyViewHolder> {
    private ArrayList<ChurchModelClass> churchModelClasses;
    Context context;
    Drawable drawable;

    public FavoriteListAdaptor(ArrayList<ChurchModelClass> churchModelClasses, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adaptor_favoritelist, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("church_id", churchModelClass.getCid());
                editor.putString(AppConstant.LATITUDE, churchModelClass.getLatitude());
                editor.putString(AppConstant.LONGITUDE, churchModelClass.getLongitude());
                editor.putString(AppConstant.KEY_NAME, churchModelClass.getCname());
                editor.putString("ChurchImage", churchModelClass.getCimg());
                Gson gson = new Gson();
